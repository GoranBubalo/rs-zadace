...
# izgradite listu duljina svih nizova u listi rijeci, 
...
duljine_sa_slovom_a = [len(rijeci) for rijeci in rijeci if 'a' in rijeci]

print(duljine_sa_slovom_a) # [6, 3, 6, 8, 9, 8, 6, 17]


#Koristeći list comprehension, izgradite listu rječnika gdje su 
# ključevi brojevi od 1 do 10, a vrijednosti kubovi tih brojeva, 
# ali samo za neparne brojeve, za parne brojeve neka vrijednost bude sam broj:
kubovi = {i: i ** 3 for i in range(1,11) if i % 2 != 0}
print(kubovi) # [{1: 1}, {2: 2}, {3: 27}, {4: 4}, {5: 125}, {6: 6}, {7: 343}, {8: 8}, {9: 729}, {10: 10}]

#Koristeći dictionary comprehension, 
# izgradite rječnik iteriranjem kroz listu 
# brojeva od 50 do 500 s korakom 50, gdje su ključevi brojevi, 
# a vrijednosti su korijeni tih brojeva zaokruženi na 2 decimale:
...
# Koristeći list comprehension, izgradite 
# listu rječnika gdje su ključevi prezimena studenata, a 
# vrijednosti su zbrojeni bodovi, iz liste studenti:
